...
export class CreatePlaceDto {
  ...
  @IsEnum(placeTypes, {
    message: requestMessages.isEnum('type', placeTypes.join(', ')),
  })
  ...
  @IsEnum(days, {
    message: requestMessages.isEnum('workDaysFrom', days.join(', ')),
  })
  ...
  @IsEnum(days, {
    message: requestMessages.isEnum('workDaysTill', days.join(', ')),
  })
